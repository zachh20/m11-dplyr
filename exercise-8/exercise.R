...
str(pulitzer)
# A lot of the numbers are characters and not int, I see why for the change in daily circulation so they can include the +/- and % at the end but im not sure why for the actual ciriculation numbers
